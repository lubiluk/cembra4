...
log_dir = "./data/free_push_cube_sb_log"
save_path = "./data/free_push_cube_sb"
best_save_path = "./data/free_push_cube_sb_best"

os.makedirs(log_dir, exist_ok=True)

def make_env():
    return DoneOnSuccessWrapper(gym.make('FreePandaPush-v1', render=False, object_shape="cube"))
